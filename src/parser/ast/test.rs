...
#[test_case(Type::custom("BruhMoment"), "BruhMoment")]
#[test_case(Type::template("BruhMoment", vec ! [Type::I64]), "BruhMoment<i64>")]
#[test_case(Type::template("BruhMoment", vec ! [Type::I64, Type::F32.as_pointer()]), "BruhMoment<i64, *f32>")]
